...
![](../images/unreal/tutorial/F/F-03.png)


![](../images/unreal/tutorial/F/F-04.jpg)

Select the PlatformVolume game object, set the Dungeon reference and enable ``Realtime Update`` (or press Rebuild Dungeon)

![](../images/unreal/tutorial/F/F-05.png)

Change the Cell Type from `Corridor` to `Room`

![Platform Volume to create a Corridor or a Room](../images/unreal/tutorial/F/F-06.gif)
