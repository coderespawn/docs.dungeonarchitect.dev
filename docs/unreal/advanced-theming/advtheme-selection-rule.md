...
![Assign an existing Selection Rule](../images/unreal/tutorial/G/G-selection_rule_01a.png)
...
![Create a new Selection Rule](../images/unreal/tutorial/G/G-create_rule_transform1.png)
...
![Override function to define logic](../images/unreal/tutorial/G/G-selection_rule_04.png)

The selection can be combined with the Probability varaible by unchecking **Logic Overrides Probability**


![Combine selection logic with Probability variable](../images/unreal/tutorial/G/G-selection_rule_02b.png)
...
![Override function to define logic](../images/unreal/tutorial/G/G-selection_rule_05.png)

And the result after applying this rule to the ground node:


![Custom selection rule attached to a mesh node](../images/unreal/tutorial/G/G-selection_rule_06.jpg)

You can add more visual nodes and experiment with the **Consume on Attach** parameter to get interesting results


![Multiple visual nodes working together](../images/unreal/tutorial/G/G-selection_rule_07.jpg)
...
![](../images/unreal/tutorial/G/G-selection_rule_eg1_1.jpg)
...
![](../images/unreal/tutorial/G/G-selection_rule_eg1_2.jpg)
...
![Stone ground mesh selection only when inside rooms](../images/unreal/tutorial/G/G-selection_rule_eg2_1.jpg)


![Room selector logic](../images/unreal/tutorial/G/G-selection_rule_eg2_2.jpg)
