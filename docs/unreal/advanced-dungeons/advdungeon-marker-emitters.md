...
![Architecture](H-da_design_me.png)
...
![Create a new marker emitter](H-create_marker_emiter_dialog.png)

Assign the created blueprint marker emitter to the Dungeon Actor


![Assign to the Dungeon actor](H-assign_marker_emitter.png)

Start placing your logic in the blueprint by overriding the **Emit Markers** function


![Override the EmitMarkers function](H-marker_emitter_04.png)
...
![Emit Marker Node](H-marker_emitter_05.png)
...
![Theme Editor's 3D Viewport > Properties > Dungeon](H-marker_emitter_te_1.png)
...
![Theme Editor's 3D Viewport > Properties > Dungeon](H-marker_emitter_te_2.jpg)
...
![Sample Marker Emitter](H-marker_emitter_eg1_1.png)
...
![Marker Emitted with this name](H-marker_emitter_eg1_2.png)


![Create a Marker node with the same name](H-marker_emitter_eg1_3.png)


![Theming engine picks it up and inserts it in the middle of the room](H-marker_emitter_eg1_4.png)
...
![Visualizing the emitter with different colored cubes](H-marker_emitter_eg2_1.png)


![Visualizing the emitter with different colored cubes](H-marker_emitter_eg2_2.jpg)
...
![Theme to create Mountains using a Marker Emitter](H-marker_emitter_eg2_3.jpg)

This gives a nice progressive elevation to the mountains giving the impression that the pathways are naturally formed


![Hell Forge theme with Mountains and Caves](H-marker_emitter_eg2_4.jpg)
...
![](H-marker_emitter_eg3_1.jpg)

![](H-marker_emitter_eg3_2.jpg)

![](H-marker_emitter_eg3_3.jpg)
