...
![](../images/unreal/tutorial/D/D-finalize_1.png)

Hit **`Build Dungeon`**.  Click `Randomize` and try other configurations.  Change the Dungeon Flow graph and experiment further

![](../images/unreal/tutorial/D/D-finalize_2.png)

Enable Debug Draw for more visual info

![](../images/unreal/tutorial/D/D-finalize_3.png)

![](../images/unreal/tutorial/D/D-finalize_4.png)
